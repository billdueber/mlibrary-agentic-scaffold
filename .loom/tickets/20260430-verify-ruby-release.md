...
Exercise the `ruby-release` skill end-to-end against a real or mock project.
...
- 2026-04-30: Closed. Skill reviewed against instructions/ruby.md. No issues found.
  Checklist, version bump, changelog update, tag/push, and CI trigger steps all
  consistent with project conventions. Manual publish fallback correct.
